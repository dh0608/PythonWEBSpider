...
def get_page(offset):
    ...
    # aid=24&app_name=web_search&offset=0&format=json&keyword=%E8%A1%97%E6%8B%8D&autoload=true&count=20&en_qc=1&cur_tab=1&from=search_tab&pd=synthesis&timestamp=1570693033992
    # https: // www.toutiao.com / api / search / content /?aid = 24 & app_name = web_search & offset = 40 & format = json & keyword = % E8 % A1 % 97 % E6 % 8
    # B % 8
    # D & autoload = true & count = 20 & en_qc = 1 & cur_tab = 1 &
    # from=search_tab & pd = synthesis & timestamp = 1570705638646
